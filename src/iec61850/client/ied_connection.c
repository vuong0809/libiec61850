...
void iedConnection_releaseOutstandingCall(IedConnection self, IedConnectionOutstandingCall call)
{
    Semaphore_wait(self->outstandingCallsLock);
...
bool iedConnection_doesControlObjectMatch(const char *objRef, const char *cntrlObj)
{
    int i = 0;
...
void IedConnection_setTimeQuality(IedConnection self, bool leapSecondKnown, bool clockFailure, bool clockNotSynchronized, int subsecondPrecision)
{
...
void IedConnection_installConnectionClosedHandler(IedConnection self, IedConnectionClosedHandler handler,
                                                  void *parameter)
{
...
void IedConnection_installStateChangedHandler(IedConnection self, IedConnection_StateChangedHandler handler, void *parameter)
{
...
void IedConnection_writeObject(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeBooleanValue(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeInt32Value(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeUnsigned32Value(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeFloatValue(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeOctetString(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_writeVisibleStringValue(IedConnection self, IedClientError *error, const char *objectReference,
...
void IedConnection_createDataSet(IedConnection self, IedClientError *error, const char *dataSetReference,
...
void IedConnection_writeDataSetValues(IedConnection self, IedClientError *error, const char *dataSetReference,
...
void iedConnection_addControlClient(IedConnection self, ControlObjectClient control)
{
    Semaphore_wait(self->clientControlsLock);
...
void iedConnection_removeControlClient(IedConnection self, ControlObjectClient control)
{
    Semaphore_wait(self->clientControlsLock);
